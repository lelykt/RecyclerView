...
public class CardviewAdapter  extends RecyclerView.Adapter<CardviewAdapter.CardViewViewHolder>{
    ...
    public CardviewAdapter(ArrayList<Rich> list) {
        this.listRich = list;
    }
    ...
    public CardViewViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_cardview_rich, viewGroup, false);
        ...
        holder.btnFavorite.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(holder.itemView.getContext(), "Favorite " +
                        listRich.get(holder.getAdapterPosition()).getName(), Toast.LENGTH_SHORT).show();
            }
        });
